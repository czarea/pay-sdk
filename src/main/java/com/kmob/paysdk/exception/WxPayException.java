package com.kmob.paysdk.exception;

import com.google.common.base.Joiner;
import com.kmob.paysdk.wxpay.response.WxPayBaseResponse;
...
public class WxPayException extends Exception {
   ...
   * 
   */
  private static final long serialVersionUID = -1081637455790406259L;
  ...
  public WxPayException(String customErrorMsg) {
    ...
    this.setCustomErrorMsg(customErrorMsg);
  }
  ...
  public static WxPayException from(WxPayBaseResponse payBaseResult) {
    return WxPayException.newBuilder().xmlString(payBaseResult.getXmlString())
        .returnMsg(payBaseResult.getReturnMsg()).returnCode(payBaseResult.getReturnCode())
        .resultCode(payBaseResult.getResultCode()).errCode(payBaseResult.getErrCode())
        .errCodeDes(payBaseResult.getErrCodeDes()).build();
  }
  ...
  public static final class Builder {
    ...
    public String buildErrorMsg() {
      return Joiner.on("，").skipNulls()
          .join(new String[] {returnCode == null ? null : String.format("返回代码：[%s]", returnCode),
