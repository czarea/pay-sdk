...
import com.czarea.pay.sdk.wxpay.constant.WxPayInteractiveConstants.RefundAccountSource;
...
public class WxPayRefundRequest extends WxPayBaseRequest {
    ...
    private static final String[] REFUND_ACCOUNT =
        new String[]{RefundAccountSource.RECHARGE_FUNDS, RefundAccountSource.UNSETTLED_FUNDS};
    /**
     * <pre>
     * 设备号
     * device_info
    ...
    protected void checkConstraints() throws WxPayException {
        ...
        if (StringUtils.isBlank(this.getOutTradeNo())
            && StringUtils.isBlank(this.getTransactionId())) {
